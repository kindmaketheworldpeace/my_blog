...
from .exceptions import NginxSettingError
...
class SingleHandlerSignal(Signal):
    ...
    """
    allowed_receiver = 'node_man.component.middlewares.RequestProvider'
